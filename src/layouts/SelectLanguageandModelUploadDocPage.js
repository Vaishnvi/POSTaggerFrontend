...
function SelectLanguageandModelUploadDocPage({selectedLanguage, selectedModels, userId}) {
    ...
    },[dropDownModels, inputText, newInputText, previouslySelectedModels]) // Empty dependency array means this effect runs once on mount
    ...
    const handleTextChange = (e) => {
      ...
      console.log("clickedEnterTxt",clickedEnterTxt)
  ...
  /*
    ...
    return(
        <div className="selectLanguageAndModelUploadDocPage">
            ...
            <div className="uploadDocUDP" style={{ left:'8.29vw', backgroundColor: clickedEnterTxt ? '#0F2749' : '' }} onClick={handleClickEnterTxt}>
                <svg className="uploadDocPicUDP" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 18" fill="none">
                    <path d="M9.9 1.8H1.8V16.2H12.6V4.5H9.9V1.8ZM1.8 0H10.8L14.4 3.6V16.2C14.4 16.6774 14.2104 17.1352 13.8728 17.4728C13.5352 17.8104 13.0774 18 12.6 18H1.8C1.32261 18 0.864773 17.8104 0.527208 17.4728C0.189642 17.1352 0 16.6774 0 16.2V1.8C0 1.32261 0.189642 0.864773 0.527208 0.527208C0.864773 0.189642 1.32261 0 1.8 0ZM3.6 8.1H10.8V9.9H3.6V8.1ZM3.6 11.7H10.8V13.5H3.6V11.7Z" fill={clickedEnterTxt ? 'white' : '#0B5E97'}/>
                </svg>
                <div className="uploadTxtUDP" style={{left:'2.48vw', width:'2.86vw', height:'1.25vw', color: clickedEnterTxt ? '#FFF' : ''}}>Enter</div>
                <div className="uploadTxtUDP" style={{left:'4.5vw', width:'4.11vw', height:'1.25vw', color: clickedEnterTxt ? '#FFF' : ''}}>Text</div>
            </div>
            <div className="orTxtUDP">Or</div>
            <div className="uploadDocUDP" style={{ left:'22.29vw', backgroundColor: clicked ? '#0F2749' : '' }} onClick={handleClick}>
                <svg className="uploadDocPicUDP" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 18" fill="none">
            ...
            {clickedEnterTxt ? (
                ...
                <div className="textToAnnotateBoxUDP"  onDrop={handleDrop} onDragOver={handleDragOver} >
                    ...
                    <div className="dragTextUDP">
                        <label>
                        <span class="before-text">Drag & drop files or </span>
                        <span class="browse-text" style={{marginLeft:'0.3vw', marginRight:'1.3vw'}}>Browse</span>
                        <input type="file" accept=".pdf, .txt" onChange={handleFileChange} style={{ display: 'none' }}/>                  
                        {file ? <span style={{color: 'green',  fontFamily:'Montserrat', fontSize:'0.83vw', fontWeight:'600', position:'relative'}} className="file-name">{file.name+" uploaded successfully!"}</span> : ''}
                        </label>
                    </div>
                    <div className="supportedFormatUDP">Supported formates: TXT, JPEG, PNG, GIF, MP4, PDF, PSD, AI, Word, PPT</div>
                </div>
            )}
